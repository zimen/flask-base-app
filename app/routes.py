    ...
    if form.validate_on_submit():
        if form.password_hash.data == form.password_hash2.data:
            ...
            if check : 
                ...
                requests.post(f"https://prod-07.centralus.logic.azure.com/workflows/2c29915665b34973a0223eca1ea86a66/triggers/manual/paths/invoke/{form.first_name.data}/{form.last_name.data}/{form.email_address.data}?api-version=2016-10-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=ppS68I1_ePRmJqxfP4aY5wpEHKWlxCnowUPJRG1cMGY")
